        ...
        <div class="container">
            <div class="row join-wrap">
                ...
                <div class="col-xs-12 col-md-9 join-form">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary" onclick="location.href='getInfo.user'">회원정보변경</button>
                        <button type="button" class="btn btn-primary" id="delCheck" onclick="location.href='delete.user'">회원 탈퇴</button>
